...
// Module: MyDemo1
// Imports: Init MyDemo1.Basic Mathlib.Tactic.Abel Mathlib.Data.Nat.Basic
#include <lean/lean.h>
...
lean_object* initialize_MyDemo1_Basic(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_MyDemo1(uint8_t builtin, lean_object* w) {
lean_object * res;
...
lean_dec_ref(res);
res = initialize_MyDemo1_Basic(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
